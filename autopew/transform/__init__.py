import logging
import itertools
from .calibration import affine_from_AB, transform_from_affine
...
class CoordinateTransform(object):
    ...
    def calibrate(self, sourcepoints, destpoints):
        ...
        self.forward = transform_from_affine(self.affine)
        self.reverse = inverse_transform_from_affine(self.affine)
