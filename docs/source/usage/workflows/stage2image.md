...
Input and output can be easily changed for your purposes see [the contributions page](../../dev/contributing.md)
...
points = Pew(laser_reference_coords, img_reference_coords).load_samples("Samples.csv")
```

## Step 3: Overlay the image and the points
