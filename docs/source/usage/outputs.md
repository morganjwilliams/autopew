...
running on [Chromium](http://www.teledynecetac.com/support/software).
...
New file types can be configured around the {py:class}`autopew.io.PewIOSpecification`
...
For example, see the soure code specification for {py:class}`autopew.io.PewSCANCSV`
